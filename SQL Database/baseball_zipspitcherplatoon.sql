...
--
-- Table structure for table `zipspitcherplatoon`
--

DROP TABLE IF EXISTS `zipspitcherplatoon`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `zipspitcherplatoon` (
  `Player` text,
  `TBFL` int(11) DEFAULT NULL,
  ...
  `OPSL` double DEFAULT NULL,
  `TBFR` int(11) DEFAULT NULL,
  ...
  `OPSR` double DEFAULT NULL,
  `BBPL` double DEFAULT NULL,
  `BBPR` double DEFAULT NULL,
  `KPL` double DEFAULT NULL,
  `KPR` double DEFAULT NULL,
  `ISOL` double DEFAULT NULL,
  `ISOR` double DEFAULT NULL,
...
-- Dump completed on 2017-07-28 15:39:39
